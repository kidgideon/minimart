  ...
  return (
    <div className="container">
      ...
      <div className="displayArea">
         <p className={styles.pageTitle}><i class="fa-solid fa-palette"></i> Store Appearance</p>
            ...
            <div className={styles.modalOverlay}>
              <div className={styles.modal}>
                ...
                <div className={styles.modalActions}>
                  <button onClick={saveColors} className={styles.saveBtn}>Save</button>
                  <button onClick={() => setShowColorModal(false)} className={styles.cancelBtn}>Cancel</button>
                </div>
              </div>
            </div>
          )}
